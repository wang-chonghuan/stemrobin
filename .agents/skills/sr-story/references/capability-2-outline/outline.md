...
- `excerpt_hint` — a candidate public-domain passage (chapter/location) that carries the idea, for cap3 to quote.
...
- Ground it in the actual book — every `focus`/`excerpt_hint` traceable to real text, no invented events.
