...
const STRINGS: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'ov.progress.unit': '/ 96 课',
    'ov.stat.learned': '已学课程',
    'ov.stat.practiced': '已练题目',
    'ov.stat.streak': '连续天数',
  ...
  en: {
    ...
    'ov.progress.unit': '/ 96 lessons',
    'ov.stat.learned': 'Lessons learned',
    'ov.stat.practiced': 'Questions practiced',
    'ov.stat.streak': 'Day streak',
