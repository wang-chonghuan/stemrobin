...
const STRINGS: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'ov.hero.title.a': '孩子的私人 AI 数学老师，',
    'ov.hero.title.b': '讲到会为止',
    'ov.hero.desc': '卡片式一步步学，做错立刻反馈。哪道题不会，AI 就换个说法再讲、无限出同类题，直到真正掌握，再带他往前一步——像请了个不知疲倦的家教，随时都在，还能超前学。',
    'ov.new': '新上线课程（{n}）',
    // lesson view
    'lesson.back': '返回',
    'lesson.practice': '练习题',
  ...
  en: {
    ...
    'ov.hero.title.a': 'A private AI math tutor that ',
    'ov.hero.title.b': 'never gives up',
    'ov.hero.desc':
      'Step by step, with instant feedback. Whatever your child gets wrong, the AI re-explains it a new way and generates unlimited practice until it truly clicks — then moves them a step ahead. A tireless private tutor, always on, ready to go beyond grade level.',
