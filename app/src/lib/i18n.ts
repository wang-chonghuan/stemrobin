...
const STRINGS: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'cat.english': '短文学英语',
    'cat.english.unit': '第 {n} 单元',
    'en.read.title': '先读懂',
    'en.read.lead': '逐句读，点小喇叭听朗读，点句子看中文。每句都读过之后，才能进入背诵天梯。',
    'en.read.play': '播放朗读',
    'en.read.gloss': '看中文',
    'en.read.markread': '读过了',
    'en.read.wasread': '已读',
    'en.read.showall': '整篇中文对照',
    'en.read.hideall': '收起整篇中文',
    'en.read.progress': '已读 {done}/{total} 句',
    'en.read.done': '全部读完了！',
  ...
  en: {
    ...
    'cat.english.unit': 'Unit {n}',
    'en.read.title': 'Read it first',
    'en.read.lead': 'Read sentence by sentence. Tap the speaker to hear it, tap the sentence for Chinese. Once every sentence is read, the recitation ladder unlocks.',
    'en.read.play': 'Play narration',
    'en.read.gloss': 'Show Chinese',
    'en.read.markread': 'Mark as read',
    'en.read.wasread': 'Read',
    'en.read.showall': 'Show Chinese for the whole text',
    'en.read.hideall': 'Hide whole-text Chinese',
    'en.read.progress': '{done}/{total} sentences read',
